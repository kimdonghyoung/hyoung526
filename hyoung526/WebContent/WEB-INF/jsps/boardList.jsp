...
<body>
	<form name="searchForm" action="<%=request.getContextPath()%>/board/boardListServlet" method="get" onsubmit="return searchCheck();" >
	<p>
